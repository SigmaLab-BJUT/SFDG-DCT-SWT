...
class EfficientNet(nn.Module):
    ...
    def forward(self, dctx : Tensor) -> Tensor:

        dctx1 = self.down_s1(dctx)
        dctx2 = self.down_s2(dctx1)
        dctx3 = self.down_s3(dctx2)
        dctx4 = self.down_s4(dctx3)
        dctx5 = self.down_s5(dctx4)
        dctx6 = self.down_s6(dctx5)
        dctx7 = self.down_s7(dctx6)
        dctx8 = self.down_s8(dctx7)
        dctx9 = self.down_s9(dctx8)

        class_x = self.avgpool(dctx9)
